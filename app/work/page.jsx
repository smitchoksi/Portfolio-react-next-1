...
const projects = [
  {
    ...
    stack: [{name: 'Html 5'}, { name: "Python"},{ name: "Django"},{ name: "Bootstrap"}],
  ...
  },
  {
    ...
    category: "frontend",
    title: "project 2",
    description: "Amazing Shopper-app Front-End Website Using Of React",
    stack: [{name: 'Html 5'}, { name: "Css 3"}, { name: "Javascript"}, { name: "React"}],
    image: "/assets/work/thumb7.png",
    live: "https://shopperwithsmit.netlify.app",
    github: "https://github.com/smitchoksi/Shopper",
  },
  {
    num: "03",
    category: "frontend",
                  ...
                  return (
                    <SwiperSlide key={index} className="w-full">
                        <div className="h-[460px] relative group flex justify-center items-center bg-pink-50/20">
                          ...
                          { /* image */}
                          <div className="relative sm: w-[20%] h-[40%]  lg: w-[90%] h-[60%]  ">
